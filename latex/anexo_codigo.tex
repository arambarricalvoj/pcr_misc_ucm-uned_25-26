...
\subsection*{Parámetros utilizados para evaluar el primer controlador de \textit{Braitenberg}}
\lstinputlisting[style=luastyle, caption={Parámetros utilizados para evaluar el primer controlador de \textit{Braitenberg}}, label={cod:t2.params_1}]{Code/tarea2/1_params.yaml}

\subsection*{Parámetros utilizados para evaluar el segundo controlador de \textit{Braitenberg}}
\lstinputlisting[style=luastyle, caption={Parámetros utilizados para evaluar el segundo controlador de \textit{Braitenberg}}, label={cod:t2.params_2}]{Code/tarea2/1_params.yaml}
